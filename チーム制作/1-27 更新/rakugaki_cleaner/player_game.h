...
public:
	...
	CScene2D *GetEraserStateUI(void) { return m_pEraserStateUI; }
	void SetEraserStateUI(CScene2D *pEraserStateUI) { m_pEraserStateUI = pEraserStateUI; }
...
private:
	...
	CScene2D *m_pEraserStateUI;				// 消しゴム状態UI
