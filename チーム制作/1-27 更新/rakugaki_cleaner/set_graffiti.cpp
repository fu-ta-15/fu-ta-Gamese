...
char CSetGraffiti::m_pFileName_SetPattern[SETTYPE_MAX][128] =
{ "data/TEXT/04_game/grafitti/pattern_01.txt" ,
"data/TEXT/04_game/grafitti/pattern_02.txt" ,
"data/TEXT/04_game/grafitti/pattern_03.txt" ,
"data/TEXT/04_game/grafitti/pattern_04.txt" };
...
{ "data/GRAFFITIDATA/35/txt/35_clock.txt" ,
"data/GRAFFITIDATA/35/txt/35_devil.txt" ,
"data/GRAFFITIDATA/35/txt/35_ghost.txt" ,
"data/GRAFFITIDATA/35/txt/35_octopus.txt" ,
"data/GRAFFITIDATA/35/txt/35_raf00.txt" ,
"data/GRAFFITIDATA/35/txt/35_raf01.txt" ,
"data/GRAFFITIDATA/35/txt/35_raf02.txt" ,
"data/GRAFFITIDATA/35/txt/35_Usaebi.txt" };

char CSetGraffiti::m_pFileName_40[TYPE_40_MAX][128] = 
{ "data/GRAFFITIDATA/40/txt/40_raf00.txt",
"data/GRAFFITIDATA/40/txt/40_raf01.txt" ,
"data/GRAFFITIDATA/40/txt/40_raf02.txt" ,
"data/GRAFFITIDATA/40/txt/40_Jo_Bi.txt" };
...
{
	// ランダム
	int nNumber = rand() % SETTYPE_MAX;

	// FILE型のポインタ関数
	FILE *pFile;

	// ファイルを開く
	pFile = fopen(&m_pFileName_SetPattern[nNumber][0], "r");
